...
import { BounceCards } from '@/components/ui/core/bounce-cards'
   ...
   return (
      <div className='w-full md:w-[400px]'>
         <div className='relative flex items-center group'>
            <Input
               className='pl-4 pr-12 h-14 w-full rounded-2xl border-muted-foreground/20 bg-background shadow-xl group-focus-within:border-primary transition-all'
